...
{
    // Mensagem de model binding é texto que o usuário lê: vai em português.
...
// O CustomizeProblemDetails não alcança o ValidationProblemDetails que o MVC monta
// sozinho, então o título do 400 de validação precisa ser traduzido aqui também.
